...
extern std::vector<std::vector<std::string>> fa_AlphabetsAllForms;
...
namespace FarsiType
{
    ...
    unsigned char GetFACharPlace(std::string fa_character, std::string prevFAChar, std::string nextFAChar);
    ...
    bool IsFACharBeginner(std::string fa_character);
   ...
   /// <returns>Returns an int in type of a char. Possible values: 0 to 44 (fa_AlphabetsAllForms array size).</returns>
    unsigned char FindFACharIndex(std::string fa_character);

    /// <summary>Check if given character is a Farsi/Arabic letter or not.</summary>
    /// <param name="fa_character">Character you want to check.</param>
    /// <returns>Returns a bool value. Possible values: true, false.</returns>
    bool IsFAChar(std::string fa_character);
    ...
    std::vector<std::string> ReverseFAText(std::string str);
    ...
    std::string GetFACharGlyph(std::string fa_character, std::string prevFAChar, std::string nextFAChar);
    ...
    std::string ConvertToFAGlyphs(std::string text);
};
